---
name: van/memory-manager
description: Defines protocols for reading from and writing to the file-based memory system, covering retrieval strategies, write formats, consolidation cadence, and session handoff procedures. Load after van/goal-manager.
version: 1.0.0
metadata:
  openclaw:
    load_order: 4
