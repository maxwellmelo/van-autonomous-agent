---
name: van/cognitive-loop
description: Governs all 6 phases of the OODA+ cycle (Observe, Orient, Decide, Act, Reflect, Evolve). Contains structured output formats, decision criteria, error handling protocols, and cycle rhythm modes. Load after van/core-identity.
version: 1.0.0
metadata:
  openclaw:
    load_order: 2
